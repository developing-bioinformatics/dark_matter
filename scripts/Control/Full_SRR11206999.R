...
out1 <- paste("outputs/Control/readlengths_",srr,".png", sep="")
...
out2 <- paste("outputs/Control/quality_",srr,".png", sep="")
...
#out3 <- paste("outputs/Control/grid_taxonomy_",srr,".png", sep="")
#ggsave(gr, file=out3, height = 9, width = 7, dpi=500)

out6 <- paste("outputs/Control/save_",srr,".RData", sep="")
...
out4 <- paste("outputs/Control/grid_Qmean_Dusty_",srr,".png", sep="")
ggsave(gr2, file=out4, height = 9, width = 7, dpi=500)

out5 <- paste("outputs/Control/clusters_Qmean_Dusty_",srr,".png", sep="")
