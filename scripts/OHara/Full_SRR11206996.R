...
out1 <- paste("outputs/OHara/readlengths_",srr,".png", sep="")
...
out2 <- paste("outputs/OHara/quality_",srr,".png", sep="")
...
out3 <- paste("outputs/OHara/grid_taxonomy_",srr,".png", sep="")
ggsave(gr, file=out3, height = 9, width = 7, dpi=500)

out6 <- paste("outputs/OHara/save_",srr,".RData", sep="")
...
histcomb3 = (ggplot(meanQscores_dustyNA) + 
  ...
  #geom_point(data=meanQscores_dustyHits,
    ...
    geom_point(data=meanQscores_dustyNA,
               aes(x=meanQ,y=Dusty,color=as.factor(cluster)),size=0.1) +
    #
...
out4 <- paste("outputs/OHara/grid_Qmean_Dusty_",srr,".png", sep="")
ggsave(gr2, file=out4, height = 9, width = 7, dpi=500)

out5 <- paste("outputs/OHara/clusters_Qmean_Dusty_",srr,".png", sep="")
